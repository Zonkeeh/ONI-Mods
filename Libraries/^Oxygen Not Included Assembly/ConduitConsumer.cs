...
public class ConduitConsumer : KMonoBehaviour
{
  ...
  public float space_remaining_kg
  {
    get
    {
      ...
      if ((UnityEngine.Object) this.storage == (UnityEngine.Object) null)
        return b;
      return Mathf.Min(this.storage.RemainingCapacity(), b);
    }
  }
  ...
  public bool IsAlmostEmpty
  {
    get
    {
      if (!this.ignoreMinMassCheck)
        return (double) this.MassAvailable < (double) this.ConsumptionRate * 30.0;
      return false;
    }
  }
  ...
  public bool IsEmpty
  {
    get
    {
      if (this.ignoreMinMassCheck)
        return false;
      if ((double) this.MassAvailable != 0.0)
        return (double) this.MassAvailable < (double) this.ConsumptionRate;
      return true;
    }
  }
