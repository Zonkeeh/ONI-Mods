  ...
  public class ELEMENTS
  {
    ...
    public class MATERIAL_MODIFIERS
    {
      ...
      public class TOOLTIP
      {
        ...
        public static LocString OVERHEATTEMPERATURE = (LocString) ("This material will add <b>{0}</b> to the finished building's " + UI.PRE_KEYWORD + "Overheat Temperature" + UI.PST_KEYWORD + string.Empty);
