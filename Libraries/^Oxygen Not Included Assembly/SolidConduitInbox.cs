...
public class SolidConduitInbox : StateMachineComponent<SolidConduitInbox.SMInstance>, ISim1000ms
{
  ...
  public class States : GameStateMachine<SolidConduitInbox.States, SolidConduitInbox.SMInstance, SolidConduitInbox>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.on.working.PlayAnim("working_pre").QueueAnim("working_loop", true, (Func<SolidConduitInbox.SMInstance, string>) null).EventTransition(GameHashes.ActiveChanged, this.on.post, (StateMachine<SolidConduitInbox.States, SolidConduitInbox.SMInstance, SolidConduitInbox, object>.Transition.ConditionCallback) (smi => !smi.GetComponent<Operational>().IsActive));
