...
public class SteamTurbine : Generator
{
  ...
  protected override void OnSpawn()
  {
    ...
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache0 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache0 = new System.Action<Sim.MassEmittedCallback, object>(SteamTurbine.OnSimEmittedCallback);
    }
    // ISSUE: reference to a compiler-generated field
    System.Action<Sim.MassEmittedCallback, object> fMgCache0 = SteamTurbine.\u003C\u003Ef__mg\u0024cache0;
    this.simEmitCBHandle = emitCallbackManager.Add(fMgCache0, (object) this, "SteamTurbineEmit");
  ...
  private void Pump(float dt)
  {
    ...
    foreach (int srcCell in this.srcCells)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      if (SteamTurbine.\u003C\u003Ef__mg\u0024cache1 == null)
      {
        // ISSUE: reference to a compiler-generated field
        SteamTurbine.\u003C\u003Ef__mg\u0024cache1 = new System.Action<Sim.MassConsumedCallback, object>(SteamTurbine.OnSimConsumeCallback);
      }
      // ISSUE: reference to a compiler-generated field
      System.Action<Sim.MassConsumedCallback, object> fMgCache1 = SteamTurbine.\u003C\u003Ef__mg\u0024cache1;
      HandleVector<Game.ComplexCallbackInfo<Sim.MassConsumedCallback>>.Handle handle = consumedCallbackManager.Add(fMgCache1, (object) this, "SteamTurbineConsume");
  ...
  public static void InitializeStatusItems()
  {
    ...
    StatusItem blockedStatusItem = SteamTurbine.inputPartiallyBlockedStatusItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache2 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache2 = new Func<string, object, string>(SteamTurbine.ResolvePartialBlockedStatus);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache2 = SteamTurbine.\u003C\u003Ef__mg\u0024cache2;
    blockedStatusItem.resolveStringCallback = fMgCache2;
    ...
    StatusItem insufficientMassStatusItem = SteamTurbine.insufficientMassStatusItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache3 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache3 = new Func<string, object, string>(SteamTurbine.ResolveStrings);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache3 = SteamTurbine.\u003C\u003Ef__mg\u0024cache3;
    insufficientMassStatusItem.resolveStringCallback = fMgCache3;
    ...
    StatusItem buildingTooHotItem = SteamTurbine.buildingTooHotItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache4 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache4 = new Func<string, object, string>(SteamTurbine.ResolveStrings);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache4 = SteamTurbine.\u003C\u003Ef__mg\u0024cache4;
    buildingTooHotItem.resolveTooltipCallback = fMgCache4;
    ...
    StatusItem temperatureStatusItem1 = SteamTurbine.insufficientTemperatureStatusItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache5 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache5 = new Func<string, object, string>(SteamTurbine.ResolveStrings);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache5 = SteamTurbine.\u003C\u003Ef__mg\u0024cache5;
    temperatureStatusItem1.resolveStringCallback = fMgCache5;
    StatusItem temperatureStatusItem2 = SteamTurbine.insufficientTemperatureStatusItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache6 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache6 = new Func<string, object, string>(SteamTurbine.ResolveStrings);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache6 = SteamTurbine.\u003C\u003Ef__mg\u0024cache6;
    temperatureStatusItem2.resolveTooltipCallback = fMgCache6;
    ...
    StatusItem wattageStatusItem = SteamTurbine.activeWattageStatusItem;
    // ISSUE: reference to a compiler-generated field
    if (SteamTurbine.\u003C\u003Ef__mg\u0024cache7 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SteamTurbine.\u003C\u003Ef__mg\u0024cache7 = new Func<string, object, string>(SteamTurbine.ResolveWattageStatus);
    }
    // ISSUE: reference to a compiler-generated field
    Func<string, object, string> fMgCache7 = SteamTurbine.\u003C\u003Ef__mg\u0024cache7;
    wattageStatusItem.resolveStringCallback = fMgCache7;
  }
    ...
    if ((UnityEngine.Object) this.gasStorage != (UnityEngine.Object) null && this.gasStorage.items.Count > 0)
    {
      ...
      if ((UnityEngine.Object) first != (UnityEngine.Object) null)
      {
        ...
        if ((double) component.Mass > (double) num2)
        {
          ...
          num1 = Mathf.Min(this.JoulesToGenerate(component) * (mass / this.pumpKGRate), this.maxWattage * dt);
          ...
          this.liquidStorage.AddLiquid(this.destElem, mass, this.outputElementTemperature, component.DiseaseIdx, disease_count, false, true);
        }
      }
    }
    float num5 = Mathf.Clamp(num1, 0.0f, this.maxWattage);
    Game.Instance.accumulators.Accumulate(this.accumulator, num5);
    if ((double) num5 > 0.0)
      this.GenerateJoules(num5, false);
    this.meter.SetPositionPercent(Game.Instance.accumulators.GetAverageRate(this.accumulator) / this.maxWattage);
    this.meter.SetSymbolTint((KAnimHashedString) SteamTurbine.TINT_SYMBOL, (Color32) Color.Lerp(Color.red, Color.green, Game.Instance.accumulators.GetAverageRate(this.accumulator) / this.maxWattage));
  }
  ...
  {
    return this.maxWattage * (float) Math.Pow(((double) steam.Temperature - (double) this.outputElementTemperature) / ((double) this.idealSourceElementTemperature - (double) this.outputElementTemperature), 1.0);
  }
  ...
  public class States : GameStateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.root.Update("UpdateBlocked", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.UpdateBlocked(dt)), UpdateRate.SIM_200ms, false);
      this.inoperational.EventTransition(GameHashes.OperationalChanged, this.operational.active, (StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.Transition.ConditionCallback) (smi => smi.master.GetComponent<Operational>().IsOperational)).QueueAnim("off", false, (Func<SteamTurbine.Instance, string>) null);
      this.operational.DefaultState(this.operational.active).EventTransition(GameHashes.OperationalChanged, this.inoperational, (StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.Transition.ConditionCallback) (smi => !smi.master.GetComponent<Operational>().IsOperational)).Update("UpdateOperational", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.UpdateState(dt)), UpdateRate.SIM_200ms, false).Exit((StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.State.Callback) (smi => smi.DisableStatusItems()));
      this.operational.idle.QueueAnim("on", false, (Func<SteamTurbine.Instance, string>) null);
      this.operational.active.Update("UpdateActive", (System.Action<SteamTurbine.Instance, float>) ((smi, dt) => smi.master.Pump(dt)), UpdateRate.SIM_200ms, false).ToggleStatusItem((Func<SteamTurbine.Instance, StatusItem>) (smi => SteamTurbine.activeStatusItem), (Func<SteamTurbine.Instance, object>) (smi => (object) smi.master)).Enter((StateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.State.Callback) (smi =>
      {
  ...
  public class Instance : GameStateMachine<SteamTurbine.States, SteamTurbine.Instance, SteamTurbine, object>.GameInstance
  {
    ...
    {
      bool flag1 = this.CanSteamFlow(ref this.insufficientMass, ref this.insufficientTemperature);
    ...
    public void UpdateStatusItems()
    {
      ...
      StatusItem status_item = !this.master.operational.IsActive ? Db.Get().BuildingStatusItems.GeneratorOffline : SteamTurbine.activeWattageStatusItem;
