...
public class AutoMinerConfig : IBuildingConfig
{
  ...
  private static void AddVisualizer(GameObject prefab, bool movable)
  {
    ...
    prefab.GetComponent<KPrefabID>().instantiateFn += (KPrefabID.PrefabFn) (go =>
    {
      ...
      if (AutoMinerConfig.\u003C\u003Ef__mg\u0024cache0 == null)
      {
        // ISSUE: reference to a compiler-generated field
        AutoMinerConfig.\u003C\u003Ef__mg\u0024cache0 = new Func<int, bool>(AutoMiner.DigBlockingCB);
      }
      // ISSUE: reference to a compiler-generated field
      Func<int, bool> fMgCache0 = AutoMinerConfig.\u003C\u003Ef__mg\u0024cache0;
      component.blocking_cb = fMgCache0;
    });
  }
}
