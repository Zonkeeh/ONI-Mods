...
public class Polymerizer : StateMachineComponent<Polymerizer.StatesInstance>
{
  ...
  private void TryEmit(PrimaryElement primary_elem)
  {
    ...
    if (!((UnityEngine.Object) primaryElement != (UnityEngine.Object) null))
      return;
    SimMessages.AddRemoveSubstance(Grid.PosToCell(vector3), primaryElement.ElementID, (CellAddRemoveSubstanceEvent) null, primaryElement.Mass, primaryElement.Temperature, primaryElement.DiseaseIdx, primaryElement.DiseaseCount, true, -1);
