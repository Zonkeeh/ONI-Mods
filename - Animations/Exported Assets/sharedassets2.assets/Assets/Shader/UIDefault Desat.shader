		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					dcl_output o0.xyzw
					dcl_temps 2
					ge r0.xy, v3.xyxx, cb0[8].xyxx
					ge r0.zw, cb0[8].zzzw, v3.xxxy
					...
					mul r0.y, r0.x, r1.w
					dp3 r0.x, r1.xyzx, l(0.220000, 0.707000, 0.071000, 0.000000)
					mov o0.xyzw, r0.xxxy
					ret 
					// Approximately 0 instruction slots used"
				}
				SubProgram "d3d11 " {
					...
					mul r2.y, r0.x, r1.w
					dp3 r2.x, r1.xyzx, l(0.220000, 0.707000, 0.071000, 0.000000)
					mov o0.xyzw, r2.xxxy
