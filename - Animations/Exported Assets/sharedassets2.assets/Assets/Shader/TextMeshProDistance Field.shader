		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					mad r0.z, -r0.z, l(0.500000), l(0.500000)
					add o3.z, r0.w, r0.z
					max r3.xyzw, cb0[26].xyzw, l(-20000000000.000000, -20000000000.000000, -20000000000.000000, -20000000000.000000)
					min r3.xyzw, r3.xyzw, l(20000000000.000000, 20000000000.000000, 20000000000.000000, 20000000000.000000)
					mad r0.xy, r0.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), -r3.xyxx
					add o4.xy, -r3.zwzz, r0.xyxx
					mul r0.xyw, r1.yyyy, cb0[12].xyxz
					mad r0.xyw, cb0[11].xyxz, r1.xxxx, r0.xyxw
					mad o5.xyz, cb0[13].xyzx, r1.zzzz, r0.xywx
					mul r1.xyzw, cb0[19].wzxy, cb0[23].yyyy
					mad r0.x, r1.x, r2.y, l(1.000000)
					div r0.x, r2.y, r0.x
					mad r0.y, r0.z, r0.x, l(-0.500000)
					mul r0.z, r0.x, r1.y
					mul r1.xy, -r1.zwzz, cb0[28].xxxx
					div r1.xy, r1.xyxx, cb0[27].zwzz
					add o6.xy, r1.xyxx, v3.xyxx
					mov o6.z, r0.x
					mad o6.w, -r0.z, l(0.500000), r0.y
					mul o7.xyz, cb0[18].wwww, cb0[18].xyzx
					mov o7.w, cb0[18].w
					mul r0.x, v4.x, l(0.000244)
					round_ni r0.z, r0.x
					mad r0.w, -r0.z, l(4096.000000), v4.x
					mul r0.xy, r0.zwzz, l(0.001953, 0.001953, 0.000000, 0.000000)
					mad o8.xy, r0.xyxx, cb0[29].xyxx, cb0[29].zwzz
					mad o8.zw, r0.xxxy, cb0[30].xxxy, cb0[30].zzzw
					ret 
					// Approximately 0 instruction slots used"
				}
				SubProgram "d3d11 " {
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					dcl_output o0.xyzw
					dcl_temps 4
					mad r0.xy, cb0[4].zwzz, cb1[0].yyyy, v8.zwzz
					sample r0.xyzw, r0.xyxx, t2.xyzw, s1
					mul r0.xyzw, r0.xyzw, cb0[5].xyzw
					mul r0.xyz, r0.wwww, r0.xyzx
					mul r1.xyz, v1.xyzx, cb0[3].xyzx
					mad r2.xy, cb0[2].xyxx, cb1[0].yyyy, v8.xyxx
					sample r2.xyzw, r2.xyxx, t1.xyzw, s0
					mul r1.xyz, r1.xyzx, r2.xyzx
					mul r2.w, r2.w, cb0[3].w
					mul r2.xyz, r1.xyzx, r2.wwww
					add r0.xyzw, r0.xyzw, -r2.xyzw
					mul r1.x, cb0[6].x, cb0[22].w
					mul r1.x, r1.x, v3.y
					...
					add r1.z, -r3.w, v3.z
					mad_sat r1.w, r1.z, v3.y, r1.x
					mad r1.x, r1.z, v3.y, -r1.x
					mul r1.y, r1.y, r1.w
					mad r0.xyzw, r1.yyyy, r0.xyzw, r2.xyzw
					mul r1.y, cb0[4].y, cb0[22].w
					mul r1.z, r1.y, v3.y
					mad r1.y, r1.y, v3.y, l(1.000000)
					mad r1.x, r1.z, l(0.500000), r1.x
					div_sat r1.x, r1.x, r1.y
					add r1.x, -r1.x, l(1.000000)
					mul r2.xyzw, r0.xyzw, r1.xxxx
					mad r0.x, -r0.w, r1.x, l(1.000000)
					sample r1.xyzw, v6.xyxx, t0.xyzw, s2
					mad_sat r0.y, r1.w, v6.z, -v6.w
					mul r1.xyzw, r0.yyyy, v7.xyzw
