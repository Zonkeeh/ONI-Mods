		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					// TEXCOORD                 2   xyz         3     NONE   float    yz 
					// TEXCOORD                 3   xyzw        4     NONE   float   xyzw
					// TEXCOORD                 4   xyzw        5     NONE   float   xyzw
					...
					dcl_output o2.xyzw
					dcl_temps 7
					lt r0.x, l(0.500000), v7.w
					add r0.yz, v2.xxyx, -v7.xxyx
					...
					if_nz r0.x
					  ...
					  if_nz r0.x
					    ...
					    if_nz r1.x
					      ...
					      if_nz r1.x
					        sample r0.xyzw, v1.xyxx, t2.xyzw, s5
					      else 
					        lt r1.x, v1.z, l(4.500000)
					        if_nz r1.x
					          sample r0.xyzw, v1.xyxx, t3.xyzw, s6
					        else 
					          lt r1.x, v1.z, l(5.500000)
					          if_nz r1.x
					            sample r0.xyzw, v1.xyxx, t4.xyzw, s7
					          else 
					            lt r1.x, v1.z, l(6.500000)
					            if_nz r1.x
					              sample r0.xyzw, v1.xyxx, t5.xyzw, s8
					            else 
					              lt r1.x, v1.z, l(7.500000)
					              if_nz r1.x
					                sample r0.xyzw, v1.xyxx, t6.xyzw, s9
					              else 
					                lt r1.x, v1.z, l(8.500000)
					                if_nz r1.x
					                  sample r0.xyzw, v1.xyxx, t7.xyzw, s10
					                else 
					                  lt r1.x, v1.z, l(9.500000)
					                  if_nz r1.x
					                    sample r0.xyzw, v1.xyxx, t8.xyzw, s11
					                  else 
					                    lt r1.x, v1.z, l(10.500000)
					                    if_nz r1.x
					                      sample r0.xyzw, v1.xyxx, t9.xyzw, s12
					                    else 
					                      lt r1.x, v1.z, l(11.500000)
					                      if_nz r1.x
					                        sample r0.xyzw, v1.xyxx, t10.xyzw, s13
					                      else 
					  ...
					  sample r0.xyzw, v1.xyxx, t11.xyzw, s2
					endif 
					mul r1.xy, v2.xyxx, cb0[5].zwzz
					mul r2.xyz, r0.xyzx, r0.xyzx
					mul r1.zw, r1.xxxy, cb0[5].xxxy
					mul r3.xyzw, r1.wwww, cb1[1].xyzw
					mad r3.xyzw, cb1[0].xyzw, r1.zzzz, r3.xyzw
					add r3.xyzw, r3.xyzw, cb1[3].xyzw
					mul r1.zw, r3.yyyy, cb2[18].xxxy
					mad r1.zw, cb2[17].xxxy, r3.xxxx, r1.zzzw
					mad r1.zw, cb2[19].xxxy, r3.zzzz, r1.zzzw
					mad r1.zw, cb2[20].xxxy, r3.wwww, r1.zzzw
					mad r1.zw, r1.zzzw, l(0.000000, 0.000000, 0.500000, -0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
					sample r3.xyzw, r1.zwzz, t12.xyzw, s1
					dp3 r1.z, r3.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
					add r3.xyz, cb0[19].xyzx, -cb0[20].xyzx
					mad r3.xyz, r1.zzzz, r3.xyzx, cb0[20].xyzx
					mul r2.xyz, r2.xyzx, r3.xyzx
					sqrt r0.xyz, r2.xyzx
					eq r1.w, v8.w, l(0.000000)
					add r2.xyz, r0.xyzx, v8.xyzx
					mul r3.xyzw, r0.xyzw, v8.xyzw
					mov r2.w, r0.w
					movc r0.xyzw, r1.wwww, r2.xyzw, r3.xyzw
					eq r1.w, v5.w, l(0.000000)
					add r2.xyz, r0.xyzx, v5.xyzx
					mul r3.xyzw, r0.xyzw, v5.xyzw
					mov r2.w, r0.w
					movc r0.xyzw, r1.wwww, r2.xyzw, r3.xyzw
					add r2.xyz, r0.xyzx, v6.xyzx
					mul r3.xyz, r2.xyzx, r2.xyzx
					mul r3.xyz, r3.xyzx, cb0[17].xyzx
					mad r2.xyz, r2.xyzx, r2.xyzx, -r3.xyzx
					mad r2.xyz, r1.zzzz, r2.xyzx, r3.xyzx
					sqrt r2.xyz, r2.xyzx
					add r1.z, -cb0[1].y, l(1.000000)
					sample r3.xyzw, r1.xyxx, t13.xyzw, s14
					min r1.w, r3.y, r3.x
					min r1.w, r3.z, r1.w
					max r2.w, r3.y, r3.x
					max r2.w, r3.z, r2.w
					...
					if_nz r4.x
					  ...
					  div r1.w, r3.w, r1.w
					  movc r4.y, r4.w, r4.z, r1.w
					  add r5.xyz, -r3.yzxy, r2.wwww
					  mul r1.w, r3.w, l(0.500000)
					  mad r5.xyz, r5.xyzx, l(0.166667, 0.166667, 0.166667, 0.000000), r1.wwww
					  div r5.xyz, r5.xyzx, r3.wwww
					  add r1.w, -r5.x, r5.y
					  eq r3.xy, r2.wwww, r3.xyxx
					  add r3.zw, r5.zzzx, l(0.000000, 0.000000, 0.333333, 0.666667)
					  add r3.zw, -r5.yyyz, r3.zzzw
					  movc r2.w, r3.y, r3.z, r3.w
					  movc r1.w, r3.x, r1.w, r2.w
					  lt r2.w, r1.w, l(0.000000)
					  lt r3.x, l(1.000000), r1.w
					  add r3.yz, r1.wwww, l(0.000000, 1.000000, -1.000000, 0.000000)
					  movc r1.w, r3.x, r3.z, r1.w
					  movc r4.x, r2.w, r3.y, r1.w
					endif 
					min r1.w, r2.y, r2.x
					min r1.w, r2.z, r1.w
					max r2.w, r2.y, r2.x
					max r2.w, r2.z, r2.w
					add r1.w, r1.w, r2.w
					mul r3.xyz, r1.wwww, l(0.500000, 0.500000, 0.500000, 0.000000)
					eq r2.w, r4.y, l(0.000000)
					if_z r2.w
					  lt r2.w, r1.w, l(1.000000)
					  add r3.w, r4.y, l(1.000000)
					  mul r3.w, r3.w, r3.z
					  mad r4.z, r1.w, l(0.500000), r4.y
					  mad r4.y, -r4.y, r3.z, r4.z
					  movc r2.w, r2.w, r3.w, r4.y
					  add r1.w, r1.w, -r2.w
					  add r5.xyzw, r4.xxxx, l(0.333333, 1.333333, -0.666667, 1.000000)
					  lt r3.w, r5.x, l(0.000000)
					  lt r4.y, l(1.000000), r5.x
					  movc r4.y, r4.y, r5.z, r5.x
					  movc r3.w, r3.w, r5.y, r4.y
					  add r4.y, -r1.w, r2.w
					  mul r4.z, r4.y, l(6.000000)
					  mad r4.w, r4.z, r3.w, r1.w
					  lt r5.xyz, r3.wwww, l(0.166667, 0.500000, 0.666667, 0.000000)
					  add r3.w, -r3.w, l(0.666667)
					  mul r3.w, r3.w, r4.y
					  mad r3.w, r3.w, l(6.000000), r1.w
					  movc r3.w, r5.z, r3.w, r1.w
					  movc r3.w, r5.y, r2.w, r3.w
					  movc r3.x, r5.x, r4.w, r3.w
					  lt r3.w, r4.x, l(0.000000)
					  lt r4.w, l(1.000000), r4.x
					  add r6.xyzw, r4.xxxx, l(-1.000000, -0.333333, 0.666667, -1.333333)
					  movc r4.x, r4.w, r6.x, r4.x
					  movc r3.w, r3.w, r5.w, r4.x
					  mad r4.x, r4.z, r3.w, r1.w
					  lt r5.xyz, r3.wwww, l(0.166667, 0.500000, 0.666667, 0.000000)
					  add r3.w, -r3.w, l(0.666667)
					  mul r3.w, r3.w, r4.y
					  mad r3.w, r3.w, l(6.000000), r1.w
					  movc r3.w, r5.z, r3.w, r1.w
					  movc r3.w, r5.y, r2.w, r3.w
					  movc r3.y, r5.x, r4.x, r3.w
					  lt r3.w, r6.y, l(0.000000)
					  lt r4.x, l(1.000000), r6.y
					  movc r4.x, r4.x, r6.w, r6.y
					  movc r3.w, r3.w, r6.z, r4.x
					  mad r4.x, r4.z, r3.w, r1.w
					  lt r5.xyz, r3.wwww, l(0.166667, 0.500000, 0.666667, 0.000000)
					  add r3.w, -r3.w, l(0.666667)
					  mul r3.w, r3.w, r4.y
					  mad r3.w, r3.w, l(6.000000), r1.w
					  movc r1.w, r5.z, r3.w, r1.w
					  movc r1.w, r5.y, r2.w, r1.w
					  movc r3.z, r5.x, r4.x, r1.w
					endif 
					mul r3.xyz, r3.xyzx, cb0[1].yyyy
					mad r0.xyz, r2.xyzx, r1.zzzz, r3.xyzx
					lt r1.z, l(0.000000), v3.z
					if_nz r1.z
					  mad r1.xy, r1.xyxx, cb0[18].xyxx, cb0[18].zwzz
					  sample r1.xyzw, r1.xyxx, t14.xyzw, s15
					  mul r1.xyz, r0.xyzx, r1.xyzx
					  mad r1.xyz, r1.xyzx, v3.zzzz, -r0.xyzx
					  mad r0.xyz, r1.xyzx, l(0.560000, 0.560000, 0.560000, 0.000000), r0.xyzx
					endif 
					lt r1.x, l(0.750000), r0.w
					mov r2.xzw, l(0,0,0,1.000000)
					mov r2.y, v3.y
					and o1.xyzw, r1.xxxx, r2.xyzw
					mad r1.xy, v2.xyxx, cb0[0].xyxx, cb0[0].zwzz
					sample r1.xyzw, r1.xyxx, t15.xyzw, s0
					ge r1.x, cb0[1].w, l(1.000000)
					lt r1.y, v4.w, l(1.000000)
					add r1.z, -v4.w, l(1.000000)
					add r1.z, -r1.z, r1.w
