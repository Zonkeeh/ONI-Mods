		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					dcl_output o2.xyzw
					dcl_temps 2
					add r0.xyzw, v1.xxyy, l(-0.010000, -0.987500, -0.010000, -0.987500)
					mul_sat r0.xyzw, r0.xyzw, l(400.000092, 400.000397, 400.000092, 400.000397)
					...
					mul r0.yw, r0.yyyw, r1.yyyw
					mad r0.xz, -r1.xxzx, r0.xxzx, l(1.000000, 0.000000, 1.000000, 0.000000)
					max r0.x, r0.y, r0.x
					max r0.x, r0.z, r0.x
					max r0.x, r0.w, r0.x
