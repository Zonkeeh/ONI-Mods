...
public class GeneShuffler : Workable
{
  ...
  protected override void OnStartWork(Worker worker)
  {
    ...
    this.notification = new Notification((string) MISC.NOTIFICATIONS.GENESHUFFLER.NAME, NotificationType.Good, HashedString.Invalid, (Func<List<Notification>, object, string>) ((notificationList, data) => (string) MISC.NOTIFICATIONS.GENESHUFFLER.TOOLTIP + notificationList.ReduceMessages(false)), (object) null, false, 0.0f, (Notification.ClickCallback) null, (object) null, (Transform) null);
  ...
  private void ApplyRandomTrait(Worker worker)
  {
    ...
    {
      Trait trait = Db.Get().traits.TryGet(stringList[UnityEngine.Random.Range(0, stringList.Count)]);
      ...
      infoDialogScreen.SetHeader((string) UI.GENESHUFFLERMESSAGE.HEADER).AddPlainText(text);
  ...
  private void ActivateChore()
  {
    ...
    this.chore = (Chore) new WorkChore<Workable>(Db.Get().ChoreTypes.GeneShuffle, (IStateMachineTarget) this, (ChoreProvider) null, true, (System.Action<Chore>) (o => this.CompleteChore()), (System.Action<Chore>) null, (System.Action<Chore>) null, true, (ScheduleBlockType) null, false, true, Assets.GetAnim((HashedString) "anim_interacts_neuralvacillator_kanim"), false, true, false, PriorityScreen.PriorityClass.high, 5, false, true);
  }
  ...
  public class GeneShufflerSM : GameStateMachine<GeneShuffler.GeneShufflerSM, GeneShuffler.GeneShufflerSM.Instance, GeneShuffler>
  {
    ...
    public override void InitializeStates(out StateMachine.BaseState default_state)
    {
      ...
      this.working.pst.EventTransition(GameHashes.AnimQueueComplete, this.consumed, (StateMachine<GeneShuffler.GeneShufflerSM, GeneShuffler.GeneShufflerSM.Instance, GeneShuffler, object>.Transition.ConditionCallback) null);
    ...
    public class Instance : GameStateMachine<GeneShuffler.GeneShufflerSM, GeneShuffler.GeneShufflerSM.Instance, GeneShuffler, object>.GameInstance
    {
