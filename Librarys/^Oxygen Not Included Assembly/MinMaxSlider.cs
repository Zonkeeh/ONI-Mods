...
public class MinMaxSlider : KMonoBehaviour
{
  ...
  protected override void OnSpawn()
  {
    ...
    Slider extraSlider = this.extraSlider;
    bool wholeNumbers = this.wholeNumbers;
    this.maxSlider.wholeNumbers = wholeNumbers;
    bool flag = wholeNumbers;
    this.minSlider.wholeNumbers = flag;
    int num2 = flag ? 1 : 0;
    extraSlider.wholeNumbers = num2 != 0;
  ...
  {
    float num1 = currentMin;
    this.minSlider.value = num1;
    this.currentMinValue = num1;
    float num2 = currentMax;
    this.maxSlider.value = num2;
    this.currentMaxValue = num2;
    this.minLimit = min;
    this.maxLimit = max;
    this.minSlider.minValue = this.minLimit;
    this.maxSlider.minValue = this.minLimit;
