  ...
  public class MISC
  {
    ...
    public class NOTIFICATIONS
    {
      ...
      public class WELCOMEMESSAGE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("I can use the " + UI.FormatAsLink("DIG TOOL", "TOOLS") + " " + UI.FormatAsHotkey("[G]") + " and the " + UI.FormatAsLink("Build Menu", nameof (MISC)) + " in the lower left of the screen to begin planning my first construction tasks.\n\nOnce I've placed a few errands my Duplicants will automatically get to work, without me needing to direct them individually.");
      ...
      {
        public static LocString NAME = (LocString) "Tutorial: Duplicant Movement";
        public static LocString MESSAGEBODY = (LocString) "Duplicants can only climb two tiles high and cannot fit into spaces smaller than two tiles, which I should keep in mind while placing errands.\n\nTo check if an errand I've placed is accessible, I can select a Duplicant and click <b>SHOW NAVIGATION</b> to view all areas within their reach.";
      ...
      public class FETCHINGWATERMESSAGE
      {
        ...
        public static LocString MESSAGEBODY = (LocString) ("By building a " + UI.FormatAsLink("Pitcher Pump", "LIQUIDPUMPINGSTATION") + " from the " + UI.FormatAsBuildMenuTab("PLUMBING TAB", "[5]") + " <color=#F44A47><b>[5]</b></color> over a pool of liquid, my Duplicants will be able to bottle it up and manually deliver it wherever it needs to go.");
      ...
      public class LOTS_OF_GERMS
      {
        ...
        public static LocString MESSAGEBODY = (LocString) (UI.FormatAsLink("Germs", "DISEASE") + " such as " + UI.FormatAsLink("Food Poisoning", "FOODSICKNESS") + " and " + UI.FormatAsLink("Slimelung", "SLIMESICKNESS") + " can cause " + UI.FormatAsLink("Disease", "DISEASE") + " in my Duplicants. I can use the " + UI.FormatAsLink("GERM OVERLAY", nameof (MISC)) + " <color=#F44A47><b>[F9]</b></color> to view all germ concentrations in my colony, and even detect the sources spawning them.\n\nBuilding Wash Basins from the " + UI.FormatAsLink("MEDICINE TAB", nameof (MISC)) + " <color=#F44A47><b>[8]</b></color> by colony toilets will tell my Duplicants they need to wash up.");
      }
      ...
      public class MORALE
      {
        public static LocString NAME = (LocString) "Tutorial: Morale";
        public static LocString TOOLTIP = (LocString) "Notes on Duplicant expectations";
        public static LocString MESSAGEBODY = (LocString) "The Foods, Rooms, Decor, and Recreation a Duplicant experiences will have an effect on their Morale. Good experiences improve their Morale and poor experiences drop it. When Morale is below their Expectations, Duplicants will become Stressed.\n\nAs Duplicants are assigned to Jobs, they gain increased Expectations, and so the colony will have to be improved to keep up their Morale. An overview of Morale and Stress can be viewed on the Vitals screen.";
      }

      public class POWER
      {
        public static LocString NAME = (LocString) "Tutorial: Power Circuits";
        public static LocString TOOLTIP = (LocString) "Notes on managing electricity";
        public static LocString MESSAGEBODY = (LocString) string.Empty;
      }

      public class DIGGING
      {
        public static LocString NAME = (LocString) "Tutorial: Digging for Resources";
      ...
      {
        public static LocString NAME = (LocString) "Tutorial: Insulation";
      ...
      {
        public static LocString NAME = (LocString) "Tutorial: Plumbing and Ventilation";
      ...
      {
        public static LocString NAME = (LocString) string.Empty;
        public static LocString TOOLTIP = (LocString) string.Empty;
      }
      ...
      {
        public static LocString NAME = (LocString) ("No " + UI.FormatAsLink("Oxygen Diffuser", "MINERALDEOXIDIZER") + " built");
      ...
      public class GENESHUFFLER
      {
        ...
        public static LocString SUFFIX = (LocString) (" has developed " + UI.PRE_KEYWORD + "{0}" + UI.PST_KEYWORD + string.Empty);
      }
