  ...
  public class DUPLICANTS
  {
    ...
    public class STATUSITEMS
    {
      ...
      public class LIGHTWORKEFFICIENCYBONUS
      {
        ...
        public static LocString TOOLTIP = (LocString) ("Better visibility from the " + UI.PRE_KEYWORD + "Light" + UI.PST_KEYWORD + " is allowing this Duplicant to work " + GameUtil.GetFormattedPercent(DUPLICANTSTATS.LIGHT.LIGHT_WORK_EFFICIENCY_BONUS * 100f, GameUtil.TimeSlice.None) + " faster");
      }
      ...
      public class DANCING
      {
        ...
        public static LocString TOOLTIP = (LocString) "This Duplicant is getting down with their bad self";
      }

      public class GAMING
      {
        public static LocString NAME = (LocString) "Playing a Game";
    ...
    public class MODIFIERS
    {
      ...
      public class METABOLISM_CALORIE_MODIFIER
      {
        ...
        public static LocString TOOLTIP = (LocString) (string.Empty + UI.PRE_KEYWORD + "Metabolism" + UI.PST_KEYWORD + " determines how quickly a critter burns " + UI.PRE_KEYWORD + "Calories" + UI.PST_KEYWORD);
      }
    ...
    public class ATTRIBUTES
    {
      ...
      public class MAXUNDERWATERTRAVELCOST
      {
        ...
        public static LocString DESC = (LocString) ("Determines a Duplicant's runspeed when submerged in " + UI.PRE_KEYWORD + "Liquid" + UI.PST_KEYWORD + string.Empty);
      }
